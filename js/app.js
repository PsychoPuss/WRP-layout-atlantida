...
const swiperMainCarousel = new core(".swiper.swiper-main", {
	loop: false,
	pagination: {
...
const swiper1PerRowCarousel = new core(".swiper.swiper-1-per-row", {
	autoplay: {
		delay: 3000,
...
const swiper3PerRowCarousel = new core(".swiper.swiper-3-per-row", {
	autoplay: {
		delay: 3000,
		pauseOnMouseEnter: true,
		disableOnInteraction: false,
...
const swiperWide = new core(".swiper.swiper-wide", {
	slidesPerView: 1,
	centeredSlides: true,
	pagination: {
...
;// CONCATENATED MODULE: ./src/js/modules/isotope_fancybox.js
...
/**
 * cookie policy
 * @author https://learn.javascript.ru/cookie
 */
...
// EXTERNAL MODULE: ./src/vendors/select-styler/LC-select-main/lc_select.min.js
var lc_select_min = __webpack_require__(556);
